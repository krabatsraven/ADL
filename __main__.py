...
from ADLClassifier import ADLClassifierWithoutForLoopWithGraphRecord, ADLClassifierWithGraphRecord, \
    WinningLayerADLClassifierWithGraphRecord, WinningLayerADLClassifierWithoutForLoopWithGraphRecord
...
def _test_example(run: bool):
    ...
    if run:
        ...
        mci_thresholds = [
            ...
            1e-5, 1e-6, 1e-7, 1e-8,
            # 1e-9,
            # 1e-10, 1e-11, 1e-12, 1e-13, 1e-14, 1e-15, 1e-50
        ]
        classifiers = [
            # WinningLayerADLClassifierWithGraphRecord, 
            # ADLClassifierWithGraphRecord,
            ADLClassifierWithoutForLoopWithGraphRecord,
